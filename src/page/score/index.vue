    ...
    methods: {
        ...
        computedScore(){
            ...
            this.answerid.forEach((item, index) => {
                // if (item > -1) {
                //     console.log(this.itemDetail[index].topic_answer[item].is_standard_answer)
                // } else {
                //     console.log(this.itemDetail[index].topic_answer)
                // }
                
                if (1 == this.itemDetail[index].topic_answer[item].is_standard_answer) {
